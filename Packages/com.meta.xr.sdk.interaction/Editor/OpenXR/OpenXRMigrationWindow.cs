    ...
    public class OpenXRMigrationWindow
    {
        ...
        private static List<AssetInfo> ToAssetInfos(List<UnityEngine.Object> objects)
        {
            List<AssetInfo> infos = objects.Select(obj =>
            {
                ...
                int instanceID = unchecked((int)EntityId.ToULong(obj.GetEntityId()));
#else
...
#if UNITY_6000_5_OR_NEWER
                editors.Add(unchecked((int)EntityId.ToULong(obj.GetEntityId())), editor);
#else
...
#if UNITY_6000_5_OR_NEWER
                && editors.TryGetValue(unchecked((int)EntityId.ToULong(obj.GetEntityId())), out editor));
#else
